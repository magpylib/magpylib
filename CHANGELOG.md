...
- Fixed canvas layout being modified even when user-provided. Also added a new `canvas_update` parameter to choose the layout behavior ([#799](https://github.com/magpylib/magpylib/pull/799))
