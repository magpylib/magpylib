...
bad_inputs = {
    ...
    "display_style_base_path_frames": (True, False, ['1'], '1'),  # bool, int or iterable
...
good_inputs = {
    ...
    "display_style_base_path_show": (True, False),  # bool, int or iterable
    "display_style_base_path_frames": (-1, [1,2], (1,3)),  # bool, int or iterable
