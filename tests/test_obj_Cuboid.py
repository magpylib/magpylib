...
def test_cuboid_object_vs_lib():
    ...
    B0 = _BHJM_magnet_cuboid(field="B", observers=pos, polarization=pol, dimension=dim)
    H0 = _BHJM_magnet_cuboid(field="H", observers=pos, polarization=pol, dimension=dim)
...
def test_Cuboid_centroid():
    """Test Cuboid centroid - should return position"""
    expected = (1, 2, 3)
