...
def test_scaling_loop():
    ...
    """
    c1 = magpy.current.CircularLoop(123, 10)
    B1 = c1.getB([1, 2, 3])
    c2 = magpy.current.CircularLoop(1230, 100)
    B2 = c2.getB([10, 20, 30])
    c3 = magpy.current.CircularLoop(12300, 1000)
    B3 = c3.getB([100, 200, 300])
    c4 = magpy.current.CircularLoop(123000, 10000)
