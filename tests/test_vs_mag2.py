...
# pm = magpy.source.magnet.Box(magnetization=(111,222,333), dim=(1,2,3))
...
# pm = magpy.source.magnet.Box(magnetization=(111,222,333), dim=(1,2,3), pos=(3,0,0))
# B = []
# for i in range(100):
#     B += [pm.getB((0,0,0))]
...
def test_vs_mag2_linear():
    ...
    pm = mag3.magnet.Box(magnetization=(111,222,333), dim=(1,2,3))
...
def test_vs_mag2_spiral():
    ...
    pm = mag3.magnet.Box(magnetization=(111,222,333), dim=(1,2,3), pos=(3,0,0))
