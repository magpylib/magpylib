...
def getBH_level1_internal_error():
    ...
    getBH_level1(bh=True,source_type='woot', magnetization=x, dimension=x, pos_obs=x,
...
def getBHv_missing_input1():
    ...
    """
    x=np.array([(1,2,3)])
    getBHv_level2(source_type='Box', pos_obs=x, magnetization=x, dimension=x)
...
def getBHv_missing_input4_box():
    ...
    """
    x=np.array([(1,2,3)])
    getBHv_level2(bh=True, source_type='Box', pos_obs=x, dimension=x)
...
def getBHv_missing_input5_box():
    ...
    """
    x=np.array([(1,2,3)])
    getBHv_level2(bh=True, source_type='Box', pos_obs=x, magnetization=x)
...
def getBHv_missing_input4_cyl():
    ...
    x=np.array([(1,2,3)])
    y = np.array([(1,2)])
    getBHv_level2(bh=True, source_type='Cylinder', pos_obs=x, dimension=y)
...
def getBHv_missing_input5_cyl():
    ...
    """
    x=np.array([(1,2,3)])
    getBHv_level2(bh=True, source_type='Cylinder', pos_obs=x, magnetization=x)
...
def getBHv_missing_input4_sphere():
    ...
    """
    x=np.array([(1,2,3)])
    getBHv_level2(bh=True, source_type='Sphere', pos_obs=x, dimension=1)
...
def getBHv_missing_input5_sphere():
    ...
    """
    x=np.array([(1,2,3)])
    getBHv_level2(bh=True, source_type='Sphere', pos_obs=x, magnetization=x)
...
def getBHv_bad_input():
    ...
    x=np.array([(1,2,3)])
    x2=np.array([(1,2,3)]*2)
    getBHv_level2(bh=True, source_type='Box', pos_obs=x, magnetization=x2, dimension=x)
