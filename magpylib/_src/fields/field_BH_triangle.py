...
def triangle_Bfield(
    *,
    ...
    surfaces defined by the triangles. The order of the triangle vertices defines the
    sign of the normal vector (right-hand-rule). The output is proportional to the
