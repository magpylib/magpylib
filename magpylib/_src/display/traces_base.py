...
def make_Cuboid(
    ...
    **kwargs : dict, optional
    ...
    3D-model: dict
        ...
        a 3D-model.
    """
    dimension = np.array(downcast(dimension, "m"), dtype=float)
    trace = {
...
def make_Ellipsoid(
    ...
    **kwargs : dict, optional
    ...
    3D-model: dict
        ...
        a 3D-model.
    """
    dimension = downcast(dimension, "m")
    N = vert
...
def make_CylinderSegment(
    ...
    **kwargs : dict, optional
    ...
    (
        ...
        r2,
        h,
    ) = downcast(dimension[:3], "m")
    phi1, phi2 = downcast(dimension[3:], "°")
...
def make_TriangularMesh(
    ...
    **kwargs : dict, optional
    ...
    3D-model: dict
        ...
        a 3D-model.
    """
    vertices = np.array(downcast(vertices, "m"))
    x, y, z = vertices.T
    if faces is None:
