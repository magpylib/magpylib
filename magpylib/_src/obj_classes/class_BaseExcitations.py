...
class BaseSource(BaseGeo, BaseDisplayRepr):
    ...
    def getB(self, *observers, squeeze=True, pixel_agg=None, output="ndarray", in_out="auto"):
    ...
    def getM(self, *observers, squeeze=True, pixel_agg=None, output="ndarray", in_out="auto"):
    ...
    def getJ(self, *observers, squeeze=True, pixel_agg=None, output="ndarray", in_out="auto"):
