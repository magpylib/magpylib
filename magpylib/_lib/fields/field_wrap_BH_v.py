...
def getBv(**kwargs):
    ...
    orientation: scipy Rotation object, default=unit rotation
        Source rotations relative to the initial state (see field implementations).
    ...
    B-field: ndarray, shape (N,3)
        B-field generated by source at observer in units of [mT].
    """
...
def getHv(**kwargs):
    ...
    H-field: ndarray, shape (N,3)
        H-field generated by source at observer in units of [kA/m].
    """
