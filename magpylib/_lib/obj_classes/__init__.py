...
__all__ = ['Cuboid', 'Cylinder', 'Sphere', 'Collection', 'Sensor',
    'Dipole', 'Loop', 'Line', 'CylinderSegment']
...
from magpylib._lib.obj_classes.class_current_Loop import Loop
from magpylib._lib.obj_classes.class_current_Line import Line
from magpylib._lib.obj_classes.class_mag_CylinderSegment import CylinderSegment
