...
* ``anglesFromAxisV(AXIS)``: This is the vectorized version of the above function. It takes an array of axis-vectors and returns an Nx2 array of the angles.
