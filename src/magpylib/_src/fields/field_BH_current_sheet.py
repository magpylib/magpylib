...
def BHJM_current_trisheet(
    ...
    ----------
    field: str
        The output field type, one of ('B', 'H', 'J', 'M').
    ...
    current: float or ndarray, shape (n,)
    ...
    Returns
    -------
    B-Field or H-Field or J-Field or M-Field: ndarray, shape (n,3)
        Field generated by current sheets at observer positions.
    """
    # pylint: disable=too-many-positional-arguments
